              ...
              <div className="bg-brand-light/5 backdrop-blur-sm rounded-[20px] p-6 sm:p-8 lg:p-10">
                ...
                <div className="bg-white rounded-[20px] p-6 border border-brand-dark/8 shadow-card mb-4 reveal-item">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      <p className="micro-label text-brand-text-muted mb-1">CONSULTATION PLANS</p>
                      <p className="font-display text-2xl font-bold text-brand-dark">From K10,500</p>
                      <p className="text-sm text-brand-text-muted mt-1">Choose Basic, Standard, or Premium.</p>
                    </div>
                    <button onClick={onBookConsultation} className="btn-primary group w-full sm:w-auto">
                      Book Consultation
