...
export default function EfficiencySection({ onExploreImpact }: EfficiencySectionProps) {
  ...
  const headlineLines = ["Reduce labor costs", "and boost productivity."];
        ...
        <div className="flex flex-col-reverse lg:flex-row items-stretch gap-8 lg:gap-0">
          ...
          <div className="w-full lg:w-1/2 lg:pr-12 xl:pr-20 flex flex-col justify-center">
            <div className="bg-brand-light/5 backdrop-blur-sm rounded-[20px] p-6 sm:p-8 lg:p-10">
              ...
              <p className="body-text text-brand-text-secondary mb-8 reveal-item">
                When signs guide customers intuitively, your team spends less time directing traffic and more time delivering value. That efficiency compounds.
              </p>
          ...
          <div className="w-full lg:w-1/2 image-container">
            <div 
              ...
              style={{ 
                backgroundImage: 'url(/efficiency_facade.jpg)',
                borderRadius: '20px'
              }}
            >
