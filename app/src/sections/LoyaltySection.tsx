...
export default function LoyaltySection({ onStartProject }: LoyaltySectionProps) {
  ...
  const headlineLines = ["Turn first-time visitors", "into loyal customers."];
        ...
        <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-0">
          ...
          <div className="w-full lg:w-1/2 image-container">
            <div 
              ...
              style={{ 
                backgroundImage: 'url(/loyalty_retail.jpg)',
                borderRadius: '20px'
              }}
            >
          ...
          <div className="w-full lg:w-1/2 lg:pl-12 xl:pl-20 flex flex-col justify-center">
            <div className="bg-brand-light/5 backdrop-blur-sm rounded-[20px] p-6 sm:p-8 lg:p-10">
              ...
              <p className="body-text text-brand-text-secondary mb-8 reveal-item">
                Clear wayfinding saves time, reduces friction, and signals professionalism. Customers remember businesses that respect their time—and come back because of it.
              </p>
